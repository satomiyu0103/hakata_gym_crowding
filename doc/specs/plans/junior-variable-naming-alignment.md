...
| 運用正本 | [variable-naming-inventory-ops.md](../../ai/guidelines/variable-naming-inventory-ops.md)（テンプレ overwrite） |
| プロジェクト台帳 | [variable-naming-inventory.md](../../ai/guidelines/variable-naming-inventory.md)（博多固有・exclude） |
